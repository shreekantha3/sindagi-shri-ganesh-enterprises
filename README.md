# Shri Ganesh Enterprises — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-shri-ganesh-enterprises/
- **Repo:** `shreekantha3/sindagi-shri-ganesh-enterprises` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-shri-ganesh-enterprises/'` for GitHub Pages project-site hosting.
